...
| v2.2 programmatic/augmentation blocks | 27k local generator implemented; 72-question r2 synthetic pilot plus 8 reward-verified MiniWoB++ samples measured; full 27k not run; 3k API block planned; 0 project human annotation | iteration 005; `configs/data/sft_120k.json`; ADR-0004 |
